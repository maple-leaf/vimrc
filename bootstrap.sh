...
############################  SETUP PARAMETERS
app_name='vimrc'
git_uri='https://github.com/maple-leaf/vimrc.git'
git_branch='master'
debug_mode='0'
fork_maintainer='0'
...
create_symlinks() {
    ...
    lnif "$endpath/.vimrc.functions"    "$HOME/.vimrc.functions"
...
msg             "© `date +%Y` http://maple-leaf.github.com/vimrc"
msg             "This is custom version of spf13-vim. Inspired by http://vim.spf13.com/"
