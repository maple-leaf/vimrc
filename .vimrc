...
" Import custom function and command {
...
" General {
    ...
    if !exists('g:spf13_no_menubar')
        set guioptions -=m          " I am a cool man, so I dont need menu bar
    endif
